...
function ValidPurchaseTests:TestReturnsTrue()
    ...
    local p = ValidPurchase:ValidPurchase(key, vendor, 6)
...
function ValidPurchaseTests:TestChoicePacketDatas()
    ...
    LuaUnit.assertEquals(packets.p[2]['Zone'], 241)
    ...
    LuaUnit.assertEquals(packets.p[5]['Zone'], 241)
